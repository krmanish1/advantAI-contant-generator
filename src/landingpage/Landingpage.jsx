            ...
            <section className="pt-8 lg:pt-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-cover">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
                    <div className="border border-indigo-600 p-1 w-60 mx-auto rounded-full flex items-center justify-between mb-4">
                        <span className="font-inter text-xs font-medium text-gray-900 ml-3">Explore how to use for free.</span>
                    ...
                    <h1
                        ...
                        AI Content
                        <span className="text-indigo-600 pl-4">Generator </span>
                    </h1>
                    <p className="max-w-sm mx-auto lg:w-1/2 text-center text-base font-normal leading-7 text-gray-500 mb-9">
                        Revolutionize your content creation with our AI-powered app, delivering engaging and high-quality text in seconds.
                    </p>
                    <a href="javascript:;"
                        className="lg:w-64 md:w-80 mb-14 inline-flex items-center justify-center py-3 px-7 text-base font-semibold text-center text-white rounded-lg bg-indigo-600 shadow-xs hover:bg-indigo-700 transition-all duration-500">
                        Get Started
